...
.. tip::  **deepchain-apps** package is component of the `deepchain.bio <https://deepchain.bio/>`_ software. Please take 5 minutes to create an account or take a look at the deepchain-apps public `hub <https://app.deepchain.bio/hub/apps>`_
...
The `deepchain-apps <https://pypi.org/project/deepchain-apps/>`_ package is hosting in pypi. The `deep-chain-apps <https://github.com/DeepChainBio/deep-chain-apps>`_ template  to build an app ican be found on github.
